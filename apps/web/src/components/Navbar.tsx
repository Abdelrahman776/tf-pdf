...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-tfwhite dark:bg-tfblack border-b border-gray-200/80 dark:border-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:flex items-center space-x-3">
            ...
            <button className="flex items-center px-3 py-2 rounded-2xl text-[0.85rem] text-tfblack dark:text-tfwhite hover:bg-gray-300 dark:hover:bg-gray-700">
              <CreditCardIcon className="w-5 h-5 mr-1" />
              <p>Credits: N/A</p>
            </button>
            <button className="px-5 py-2 rounded-2xl text-tfwhite dark:text-tfwhite bg-tfblue hover:bg-blue-950 transition-colors flex items-center text-sm font-semibold">
